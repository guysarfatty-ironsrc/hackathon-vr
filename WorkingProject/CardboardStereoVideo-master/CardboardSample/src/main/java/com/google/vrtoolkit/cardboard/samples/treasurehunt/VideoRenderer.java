 ...
 * https://matthewwellings.com/blog/playing-stereo-3d-video-in-cardboard-apps/
 */
public class VideoRenderer implements MediaPlayer.OnCompletionListener {
...
//    private int textureParam;
    ...
    private void setUpVideo() {
        ...
        try
        {
            AssetFileDescriptor afd = parentMainActivity.getAssets().openFd("sonicdemo.mp4");
    ...
    public void onCompletion(MediaPlayer mp) {
        //TODO - display 3D toast
        parentMainActivity.getOverlayView().show3DToast("You got 10 Diamonds motherfucker!");
        cleanup();
        //setUpVideo();
    }
}
